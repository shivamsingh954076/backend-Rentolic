                            ...
                            <div className="col-md-6">
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-sm-9">
                                        ...
                                        <p>Recommended Image Size (1350px X 620px)</p>
                                    </div>
                                </div>
                                ...
                                <div className="form-group row">
                                    <label className="col-sm-3 col-form-label">Slider Mega Title</label>
                                    <div className="col-sm-9">
                                        <input type="text" name="content" className="form-control" onChange={onChangeHandler} placeholder="Ccontent" />
                                    </div>
                                </div>
