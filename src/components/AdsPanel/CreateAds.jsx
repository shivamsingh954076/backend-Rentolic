                        ...
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                {/* <div className="form-group row">
                                    ...
                                    <div className="col-sm-9">
                                        <input type="text" className="form-control" name="subtitle" placeholder='Subtitle' onChange={onChangeHandler} />
                                    </div>
                                </div> */}
                                <div className="form-group row">
                                    <label className="col-sm-3 col-form-label">Link </label>
                                    <div className="col-sm-9">
                                        <input type="text" className="form-control" name="buttonText" placeholder='Ex : /product/Titanic/70' onChange={onChangeHandler} />
                                    </div>
                                </div>
                                <div className="form-group row">
